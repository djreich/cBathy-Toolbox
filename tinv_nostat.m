function x = tinv_nostat(p,v);
% TINV_NOSTAT   Inverse of Student's T cumulative distribution function (cdf).
%   X=TINV_NOSTAT(P,V) returns the inverse of Student's T cdf with V degrees 
